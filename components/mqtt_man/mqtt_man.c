...
static const char *BROKER_URI = "wss://mqtt.tnstlab.com:443";
...
void mqtt_app_start(void)
{
    const esp_mqtt_client_config_t mqtt_cfg = {
        ...
        .credentials.authentication.password = (const char *)"testpassword",
        .credentials.username = (const char *)"testuser",
    };
